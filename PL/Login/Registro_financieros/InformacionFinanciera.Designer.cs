namespace ProyectoFinalMargarita
{
    partial class InformacionFinanciera
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Ingreso_mensual
            // 
            Ingreso_mensual.Font = new Font("Inter", 11F, FontStyle.Bold);
            ...
            Ingreso_mensual.TextChanged += rjTexbox1_TextChanged;
            // 
            // label8
            // 
            ...
            // Nombre_Empresa
            // 
            Nombre_Empresa.Font = new Font("Inter", 11F, FontStyle.Bold);
            ...
            Nombre_Empresa.TextChanged += rjTexbox1_TextChanged;
            // 
            // label9
            // 
            ...
            label10.Size = new Size(251, 26);
            label10.TabIndex = 29;
            label10.Text = "Tiempo en la empresa";
            // 
            // Tiempo_Empresa
            // 
            Tiempo_Empresa.Font = new Font("Inter", 11F, FontStyle.Bold);
            Tiempo_Empresa.ForeColor = Color.Black;
            Tiempo_Empresa.Location = new Point(221, 684);
            Tiempo_Empresa.Multiline = true;
            Tiempo_Empresa.Name = "Tiempo_Empresa";
            Tiempo_Empresa.Size = new Size(413, 35);
            Tiempo_Empresa.TabIndex = 78;
            Tiempo_Empresa.TextChanged += rjTexbox1_TextChanged;
            // 
            // label11
            // 
            ...
            label11.Size = new Size(292, 26);
            label11.TabIndex = 29;
            label11.Text = "¿Ha tenido credito antes?";
            // 
            // Credito
            // 
            Credito.Font = new Font("Inter", 11F, FontStyle.Bold);
            Credito.ForeColor = Color.Black;
            Credito.Location = new Point(741, 684);
            Credito.Multiline = true;
            Credito.Name = "Credito";
            Credito.Size = new Size(407, 35);
            Credito.TabIndex = 78;
            Credito.TextChanged += rjTexbox1_TextChanged;
            // 
            // roundButton3
            // 
            ...
            // Deudas_Activas
            // 
            Deudas_Activas.Font = new Font("Inter", 11F, FontStyle.Bold, GraphicsUnit.Point, 0);
            Deudas_Activas.ForeColor = Color.Black;
            Deudas_Activas.FormattingEnabled = true;
            Deudas_Activas.Items.AddRange(new object[] { "Tarjetas de crédito", "Préstamos", "Hipotecas" });
            ...
            Deudas_Activas.SelectedIndexChanged += comboBox2_SelectedIndexChanged;
            // 
        ...
        private TextBox Tiempo_Empresa;
